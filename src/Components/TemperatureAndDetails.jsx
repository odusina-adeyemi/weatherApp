...
const TemperatureAndDetails = ({weather: {
    details, icon, temp, temp_min, temp_max, sunrise, sunset, speed, wind, humidity, feels_like, timezone
}}) => {
  return (
    <div>
        ...
        <div className='flex flex-row items-center justify-between text-white py-3'>
            ...
            <p className='flex text-5xl flex-col font-medium space-y-2'>{`${temp.toFixed()}°`}</p>
